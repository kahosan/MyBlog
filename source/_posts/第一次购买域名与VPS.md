...
{% img https://cdn.jsdelivr.net/npm/xfb@0.5.0/img/new/Namesilo.png namesilo %}  

<br/>

创建个账号，然后搜索下喜欢的域名是不是已经被购买了，没有的话直接点 Add 然后再点 checkout 购买就行了。

{% img https://cdn.jsdelivr.net/npm/xfb@0.5.0/img/new/buy.png namesilo %}
...
{% img https://cdn.jsdelivr.net/npm/xfb@0.5.0/img/new/vps.png namesilo %}
...
{% img https://cdn.jsdelivr.net/npm/xfb@0.5.0/img/new/zz.png namesilo %}  
